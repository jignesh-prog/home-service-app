...
import AddPostScreen from "../Screens/AddPostScreen/AddPostScreen.jsx"
...
export default function TabNavigation() {
  return (
    ...
    <Tab.Screen options={{tabBarIcon:({color,size}) => (<FontAwesome name="bookmark" size={24} color={color} />)}} name="AddPost" component={AddPostScreen} />
  </Tab.Navigator>
